public class VariablesRange {
  public static void main(String[] args) {

     System.out.println("Integer is from " + Integer.MIN_VALUE + " to " + Integer.MAX_VALUE +".");
     System.out.println("The size of an Integer is "+ Integer.SIZE +".\n");

     System.out.println("Double is from " + Double.MIN_VALUE + " to " + Double.MAX_VALUE +".");
     System.out.println("The size of a Double is "+ Double.SIZE +".\n");

      System.out.println("Float is from " + Float.MIN_VALUE + " to " + Float.MAX_VALUE +".");
     System.out.println("The size of a Float is "+ Float.SIZE +".\n");
